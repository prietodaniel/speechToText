...
filename = "/content/drive/MyDrive/Colab Notebooks/PruebaAudio.wav"
...
path = "/content/drive/MyDrive/Colab Notebooks/PruebaAudio.wav"
full_text = get_large_audio_transcription(path)

f = open ('/content/drive/MyDrive/Colab Notebooks/PruebaAudio.txt','a')
f.write(full_text)
f.close()
